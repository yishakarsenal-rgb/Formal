...
function FloatingTorus({ position, scale, color, speed }: {
  ...
  return (
    <Float speed={speed * 0.8} rotationIntensity={0.5} floatIntensity={0.6}>
      <Torus ref={ref} args={[1, 0.3, 16, 60]} position={position} scale={scale}>
...
function FloatingOctahedron({ position, scale, color, speed }: {
  position: [number, number, number]
  scale: number
  color: string
  speed: number
...
function FloatingBox({ position, scale, color, speed }: {
  position: [number, number, number]
  scale: number
  color: string
  speed: number
...
function Scene() {
  return (
    <>
      ...
      {/* Left side shapes */}
      <FloatingTorus position={[-9, 3, -4]} scale={1.2} color="#1d4ed8" speed={1.2} />
      <FloatingOctahedron position={[-7, -3, -3]} scale={0.9} color="#0369a1" speed={0.9} />
      <FloatingIcosahedron position={[-11, 0, -5]} scale={1.0} color="#0284c7" speed={1.1} />
      <FloatingBox position={[-6, 4, -5]} scale={0.7} color="#0ea5e9" speed={0.8} />

      {/* Right side shapes */}
      <FloatingTorus position={[9, -3, -4]} scale={1.1} color="#2563eb" speed={1.0} />
      <FloatingOctahedron position={[7, 4, -3]} scale={1.0} color="#1e40af" speed={1.3} />
      <FloatingIcosahedron position={[11, -1, -5]} scale={0.8} color="#38bdf8" speed={0.7} />
      <FloatingBox position={[6, -5, -4]} scale={0.9} color="#7dd3fc" speed={1.1} />

      {/* Top/bottom accent shapes */}
      <FloatingTorus position={[0, 7, -6]} scale={0.7} color="#1d4ed8" speed={0.6} />
      <FloatingOctahedron position={[3, -6, -5]} scale={0.6} color="#0c4a6e" speed={0.8} />
      <FloatingIcosahedron position={[-3, 6, -6]} scale={0.5} color="#3b82f6" speed={0.9} />
    </>
  )
}
