        ...
        <div className="flex items-start gap-4">
          ...
          <div className="min-w-0">
            <div className="flex items-center gap-2 mb-1">
              <Badge variant="secondary" className="text-xs">Chapter {chapter.number}</Badge>
            </div>
            <h2 className="text-xl font-bold text-foreground text-balance">{chapter.title}</h2>
            <p className="text-sm text-muted-foreground mt-1 leading-relaxed">{chapter.description}</p>
          </div>
        </div>
      </div>
      ...
      <ScrollArea className="flex-1">
        <div className="p-6">
          {chapter.sections.length === 1 ? (
            ...
            <Tabs defaultValue={chapter.sections[0].id} className="w-full">
