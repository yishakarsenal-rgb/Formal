  ...
  return (
    <Card className="overflow-hidden">
      <CardHeader className="pb-2">
        ...
        <CardTitle className="text-sm font-semibold mt-1">{example.title}</CardTitle>
      </CardHeader>
      <CardContent className="space-y-3">
        ...
        >
          ...
          {showSolution ? <ChevronUp className="size-3.5 ml-auto" /> : <ChevronDown className="size-3.5 ml-auto" />}
        </Button>
